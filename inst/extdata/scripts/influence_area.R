...
setwd("C:\\Users\\LageeInpe\\Documents\\ghProjects\\cqmaTools")

load_all()

#---- Configuration ----

hysplit_path <-  "C:\\Users\\LageeInpe\\Documents\\Influence_Area\\Hysplit_Results\\2voos_2010_2023"
#out_dir <- "C:\\Users\\LageeInpe\\Documents\\Influence_Area\\Inf_Area\\sem_filtros"
out_dir <- "C:\\Users\\LageeInpe\\Documents\\Influence_Area\\Inf_Area\\test_20240902"
...
process_period <- function(m_period, split_by, raster_palette = "viridis",
                           raster_colors = 100) {
...
pfiles <- character(0)
for (m_period in list(YEAR.TRIMESTERS, YEAR.YEAR)) {
...
pfiles <- character(0)
for (m_period in list(YEAR.TRIMESTERS)) {
    m_period <- unlist(m_period)
